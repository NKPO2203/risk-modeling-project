...
Les 114 dossiers restants sont tranchés avec la règle III inchangée. Le registre compte maintenant 130 ENTRE et 370 SORT. Les 386 décisions déjà prises ont été comparées cellule par cellule et conservées. Les 500 citations, empreintes de texte et positions normalisées ont été vérifiées sur le corpus local et le complément officiel HONA. Aucun verdict en attente ne subsiste, y compris après application du registre par le pipeline. Les dix-huit citations auparavant absentes sont renseignées.

La lecture porte sur les passages repérés, leur contexte et des recherches complémentaires dans les présentations d'activité. Le relevé `couverture_selection_finition_2026-09-08.csv` distingue cette méthode d'une lecture intégrale des 114 rapports. La revue ne prétend pas avoir audité chaque page ni avoir découvert toutes les expositions possibles. Les exclusions pour preuve insuffisante restent des exclusions documentaires dans le cadre imposé.

Honeywell Aerospace n'avait aucun rapport dans le cache initial. Sa notice officielle de séparation a été consultée sur le site SEC. Le téléchargement complet par le collecteur a reçu un refus HTTP 403 ; seul l'extrait décisif a été conservé dans `sources_finition_2026-09-08/HONA.txt`, avec URL, dépôt, CIK et empreinte. Le chargeur refuse une pièce altérée, une URL d'un autre CIK ou le remplacement silencieux d'un rapport désormais présent. Quatre tests couvrent ces cas.

Les nouvelles entrantes sont les suivantes. Les motifs ne mesurent pas une part de revenu IA :

**APD.** La description des débouchés des gaz vendus cite la fabrication des semi-conducteurs et des fibres optiques. Fourniture industrielle établie en amont du calcul ; la part propre à l'IA n'est pas isolée. [Rapport](https://www.sec.gov/Archives/edgar/data/2969/000000296925000055/apd-20250930.htm).

**EMR.** Le portefeuille d'automatisation sert explicitement la fabrication de semi-conducteurs. La fourniture est décrite comme une activité actuelle ; la revue du segment Test & Measurement confirme les systèmes de test vendus. L'exposition à l'IA reste indirecte et non mesurée. [Rapport](https://www.sec.gov/Archives/edgar/data/32604/000003260425000087/emr-20250930.htm).

**ITW.** Le segment Test & Measurement and Electronics vend équipements et consommables de fabrication de microélectronique. Les ventes au marché des semi-conducteurs sont explicitement décrites. L'activité est établie ; la croissance citée sert à identifier le débouché, pas de critère de corroboration comptable. [Rapport](https://www.sec.gov/Archives/edgar/data/49826/000004982626000008/itw-20251231.htm).

**NDSN.** Les équipements de dépôt, de test et d'inspection servent explicitement les fabricants de semi-conducteurs et de circuits imprimés. Fourniture établie en amont des équipements de calcul, sans ventilation du revenu propre à l'IA. [Rapport](https://www.sec.gov/Archives/edgar/data/72331/000007233125000144/ndsn-20251031.htm).

**PH.** Le passage sur les data centers seul était prospectif. La revue élargie établit en revanche des ventes actuelles d'équipements industriels au marché des semi-conducteurs. Ce débouché suffit sous la règle III, sans utiliser sa croissance comme condition comptable ni mesurer la part IA. [Rapport](https://www.sec.gov/Archives/edgar/data/76334/000007633426000105/ph-20260630.htm).

**HD.** Les clients professionnels servis construisent et entretiennent notamment des data centers. Le débouché de distribution de fournitures de construction est établi, au même seuil documentaire que Fastenal ; l'importance de ce débouché et sa part IA ne sont pas mesurées. [Rapport](https://www.sec.gov/Archives/edgar/data/354950/000162828026019436/hd-20260201.htm).

**EXPD.** Les services de transport, entreposage et distribution livrent effectivement les équipements de clients investissant dans l'infrastructure IA. Le rapport identifie aussi semi-conducteurs et matériel de calcul parmi les marchandises traitées. Fourniture logistique de la chaîne, sans assimiler toute la logistique à l'IA. [Rapport](https://www.sec.gov/Archives/edgar/data/746515/000119312526071569/expd-20251231.htm).

**NEE.** Le rapport documente le contrat de 25 ans pour la totalité de Duane Arnold et la demande de remise en service. Le communiqué officiel du 27 octobre 2025 rattache ce même accord à Google et à ses besoins d'infrastructures IA. Engagement concret soumis à autorisations, pas production déjà livrée. [Rapport](https://www.sec.gov/Archives/edgar/data/753308/000075330826000015/nee-20251231.htm).

**QCOM.** Une activité Data Center est constituée et développe des solutions propres ; le rapport détaille la R&D et l'accord d'acquisition d'Alphawave avec trésorerie réservée. Engagement documenté dans le calcul centralisé, sans supposer que les ventes de puces pour téléphones sont des revenus d'infrastructure IA ni qu'un niveau de ventes data center est déjà établi. [Rapport](https://www.sec.gov/Archives/edgar/data/804328/000080432825000085/qcom-20250928.htm).

**SBAC.** La revue élargie distingue les intentions de développement des centres de données déjà acquis et détenus. Les installations existent dans la chaîne, même si leur rôle dans le groupe est exploratoire et leur part IA inconnue. [Rapport](https://www.sec.gov/Archives/edgar/data/1034054/000103405426000002/sbac-20251231x10k.htm).

**NDAQ.** La colocation vendue aux participants de marché comprend espace, alimentation et hébergement de leurs serveurs. Infrastructure de calcul effectivement exploitée pour des tiers ; l'usage financier domine et la part IA n'est pas établie, comme pour les autres data centers généralistes. [Rapport](https://www.sec.gov/Archives/edgar/data/1120193/000162828026007703/ndaq-20251231.htm).

**FSLR.** Le rapport rattache l'expansion de capacité solaire à la croissance de demande électrique, notamment des data centers, et identifie une sixième usine américaine en construction. Engagement industriel documenté en amont de leur alimentation ; ni les panneaux photovoltaïques ni leurs semi-conducteurs ne sont assimilés à des processeurs, et le débouché IA de l'usine reste non isolé. [Rapport](https://www.sec.gov/Archives/edgar/data/1274494/000127449426000021/fslr-20251231.htm).

**LDOS.** Le segment conçoit, déploie et maintient les environnements informatiques des clients, avec modernisation explicite des data centers et réseaux. Offre technique établie, distincte du seul logiciel applicatif ; la part IA n'est pas quantifiée. [Rapport](https://www.sec.gov/Archives/edgar/data/1336920/000133692026000030/ldos-20260102.htm).

**NOW.** Un contrat non résiliable porte précisément sur l'achat d'équipements pour étendre les data centers, dont la section Technology and Operations décrit les serveurs, réseaux et stockage déjà exploités. L'entrée repose sur cette capacité matérielle propre, pas sur les applications IA vendues. Le partage entre IA et autres charges de travail reste inconnu. [Rapport](https://www.sec.gov/Archives/edgar/data/1373715/000137371526000007/now-20251231.htm).

**NXPI.** Les processeurs de communication ont un usage explicite de déchargement des serveurs cloud. Le contexte décrit la gamme commercialisée ; l'entrée repose sur ce composant d'infrastructure établi, pas sur le seul nom de fabricant de semi-conducteurs ni sur l'IA embarquée automobile. [Rapport](https://www.sec.gov/Archives/edgar/data/1413447/000141344726000008/nxpi-20251231.htm).

**ACN.** Les services actuels aident les clients à planifier, gérer et exécuter les projets de construction de data centers. Le tableau de clients cite aussi fabricants de semi-conducteurs et équipements. Fourniture technique de réalisation des infrastructures, sans retenir le simple conseil applicatif. [Rapport](https://www.sec.gov/Archives/edgar/data/1467373/000146737325000217/acn-20250831.htm).

**APP.** La section des coûts distingue des équipements de serveurs et de réseau détenus sous contrats de financement, et la note de liquidité isole leurs engagements non résiliables. L'entrée repose sur cette infrastructure matérielle engagée pour le moteur publicitaire IA, pas sur l'activité publicitaire elle-même ; ni les baux ni les coûts globaux ne mesurent une part de revenu IA. [Rapport](https://www.sec.gov/Archives/edgar/data/1751008/000175100826000010/app-20251231.htm).

La règle produit encore des cas de frontière. Home Depot est retenu pour des clients professionnels qui construisent des centres de données ; Nasdaq pour son activité de colocation ; Expeditors pour la livraison et l'entreposage d'équipements de calcul. FSLR relève de l'engagement documenté, pas d'une vente quantifiée à l'IA. Ces choix appliquent le seuil existant. Ils montrent sa largeur et ne justifient pas de le remplacer à la fin du screening. Pour NEE, le raccordement du contrat nucléaire à Google est explicité dans la limite de preuve et le communiqué officiel associé.

Les 97 autres dossiers relus finissent en SORT, avec les motifs individuels et les citations du journal `decisions_finition_2026-09-08.csv`. Une participation financière, l'utilisation interne d'outils d'IA ou une demande future non engagée ne deviennent pas à elles seules un rôle technique retenu. Aucun critère comptable abandonné n'a été réintroduit. Les sujets déjà corrigés dans l'audit précédent ne sont pas rouverts.

## II. Travail 2 : prix des nouvelles entreprises

Dix-sept historiques complets ont été acquis par yfinance avec `auto_adjust=False` et les actions sur titres, jusqu'au même cliché du 4 septembre 2026. Les dix colonnes attendues sont conservées. Les gardes refusent l'écrasement, l'absence de données ou de première transaction ; chaque description porte le symbole attendu, EQUITY et USD. Les nouvelles lignes de métadonnées n'ont remplacé aucune ancienne ligne. Le manifeste contient les lignes, bornes, empreintes et raisons des ajouts.

Les distributions ont été rapprochées des facteurs et des versements habituels. Leidos porte deux versements spéciaux : les sources de l'émetteur confirment leur nature monétaire. Le versement de juin 2013 est dans des unités retraitées par la scission ultérieure ; le coefficient Yahoo n'est pas certifié pour autant. Les distributions Versum/APD et nouveau SAIC/Leidos sont documentées comme opérations sur titres. Les facteurs restent une convention de prix du fournisseur.

Une erreur nouvelle est confirmée sur Home Depot : 0,05 dollar apparaît les 27 et 28 novembre 2001, alors que l'émetteur indique un seul détachement au 27 novembre, payable le 13 décembre. La correction retire le second versement en mémoire et laisse le premier intact. Son effet direct est de retirer `0,05 / 43,3499984741`, soit environ 11,53 points de base de richesse artificielle sur le titre au second jour. [Historique officiel](https://ir.homedepot.com/stock-information/dividend-history).

Le rapprochement Nasdaq passe de 43 à 60 titres et atteint 144 990 clôtures communes. Les dix-sept nouvelles requêtes sont archivées. Les trois écarts ajoutés sont un écart de convention APD sur Versum et deux écarts SBAC autour d'un cours figé : la règle de valorisation porte ce cours puis prend le rendement cumulé à la reprise. Les neuf divergences anciennes non arbitrées restent écrites. Aucun chantier supplémentaire de certification de prix n'est engagé.

## III. Travail 3 : continuité des historiques
...
Une acquisition ordinaire, une réorganisation juridique à actifs continus ou une scission laissant le parent dans la même lignée ne redémarrent pas mécaniquement l'historique. Une cotation conditionnelle est conservée lorsqu'elle porte déjà sur l'action à recevoir, distinctement du parent. Les bornes reposent sur les pièces publiées, sans optimisation de performance. Le protocole est exploratoire : les données avaient déjà été consultées. Ces bornes ne datent pas le commencement de l'exposition à l'IA.

JCI commence désormais le 6 septembre 2016. La série antérieure appartient à Tyco, tandis que Johnson Controls Inc. est le prédécesseur comptable du groupe combiné. Le même raisonnement borne PLD au 3 juin 2011, BKR au 5 juillet 2017 et SWKS au 26 juin 2002. Les dates, preuves et motifs sont dans `regles_historiques_prix.csv`, aux côtés des trois bornes GOOG, DELL et VRT.

PLD donne une vérification particulièrement directe : aux 26 janvier, 28 janvier et 2 mai 2011, Yahoo porte environ 32,86, 32,93 et 36,36 dollars. Le document de fusion attribue ces cours à AMB. Le ProLogis antérieur, prédécesseur comptable, cotait respectivement 14,70, 15,21 et 16,29 dollars. Ce n'est donc pas seulement un soupçon fondé sur un changement de nom. [Document de fusion](https://ir.prologis.com/financials/sec-filings/content/0000950123-11-043952/d81723sv4.htm).

À l'inverse, le cours EVRG du 1er juin 2018 retrouve Westar : 55,080002 dans le cliché contre 55,08 dans la pièce. Westar est le prédécesseur comptable et ses actions sont échangées une pour une. L'historique est conservé. Les détails de cette contre-vérification, ainsi que les continuations AVGO/Avago et COHR/II-VI, sont consignés individuellement.

Les 131 séries ont passé le dépistage de début d'historique. Le repérage compare les soixante premières observations à volume positif au reste de la série : bande inférieure à 10 %, médiane à moins d'un dollar de 10, volatilité quotidienne inférieure à 0,5 % et volatilité ultérieure plus de trois fois supérieure. Seul VRT est signalé. Ce dépistage ne peut pas détecter à lui seul un autre prédécesseur économique qui cote normalement.

**Séries examinées sans nouvelle borne de continuité :** ACN, ADI, AES, AMAT, AMD, AME, ANET, APD, APH, APP, ARES, AVGO, BRK-B, CARR, CAT, CDNS, CDW, CEG, CIEN, CNP, COHR, CSCO, CVX, D, DOV, DOW, DTE, DUK, EMR, EQIX, ETN, EVRG, EXPD, FAST, FLEX, FSLR, GD, GEV, GOOGL, HAL, HD, HPE, HUBB, HWM, IBM, IEX, INTC, IRM, ITW, KEYS, KLAC, LDOS, LITE, LRCX, MCHP, MMM, MRVL, MSFT, MU, NDAQ, NDSN, NEE, NI, NOW, NUE, NVDA, NXPI, O, ORCL, PH, PPL, PWR, Q, QCOM, SBAC, SNDK, SO, STX, TDY, TEL, TPL, TT, VST, WDC, WEC, WMB. Les cas concernés par une scission, une transformation, un facteur non entier ou une entrée récente sont distingués dans `continuite_examinee_2026-09-08.csv`. « Sans nouvelle borne » signifie qu'aucun remplacement d'instrument n'a été établi dans cette revue ; cela ne certifie ni toutes les unités anciennes ni la stabilité des métiers. Les facteurs exclusivement antérieurs à 2000 sont explicitement séparés des rendements de la fenêtre étudiée.

**Autres séries couvertes par le dépistage et les métadonnées :** AEE, AEP, AKAM, AMT, AMZN, CBRE, CMI, CMS, CRH, DLR, ECL, EME, ETR, FE, FIX, GLW, GNRC, JBL, LII, LNT, META, MLM, MPWR, NRG, NTAP, ON, PNW, SLB, SMCI, SNPS, SRE, STLD, TER, TSLA, TXN, VMC, XEL, XYL. Une généalogie juridique exhaustive de chaque acquisition n'est pas revendiquée. Les pièces d'opérations et la couverture effectivement relue restent disponibles, sans prétendre qu'un registre exhaustif des actions sur titres a été constitué.

Les corrections sont vérifiées sur le cliché complet avant de borner les prix. Cela conserve le contrôle de JCI 2007 tout en excluant ce rendement des portefeuilles. Les sept bornes n'effacent aucune ligne brute.

## IV. Travail 4 : carnet et empreintes

Les quatre cellules de code du carnet de construction ont été exécutées dans l'ordre, dans un processus Python 3.12.14 neuf, sans réutiliser de variables d'une session interactive. Les sorties, compteurs d'exécution et version Python ont été enregistrés. Les 18 sorties de données sont identiques à l'octet à la reconstruction sous Python 3.13.9. L'empreinte du carnet enregistré est liée au manifeste final. Il n'y a pas de second moteur dans le notebook.

## V. Travail 5 : reconstruction et documentation

Les deux commandes de reconstruction et leurs contrôles de manifeste sont rejoués sur les entrées finales. La suite complète compte 103 tests réussis. La partition par maturité et la partition par chaîne recomposent toutes deux P1 par CIK. L'identité quotidienne tient sur les vingt séries : le maximum en mémoire est inférieur à 10⁻¹². Une relecture indépendante des CSV donne 9.281e-16, l'écart d'arrondi restant bien sous le même seuil. Les frais correspondent au taux annoncé sur le montant échangé.

Les tableaux courants sont produits depuis les fichiers, avec les mêmes valeurs dans le plan, les règles et l'audit. Les anciennes notes sont conservées dans `research/archive/2026-09-08_avant_finition/`, avec un avertissement explicite : leurs chiffres ne décrivent pas l'univers final. Les options pédagogiques du contexte maître restent distinctes de son état opérationnel actualisé.
...
Les 38 cours portés sont détaillés dans le contrôle des prix. Les relevés mensuels contiennent 258 726 lignes sur 321 dates. Les maxima de poids cités dans les notes sont des maxima de ces relevés, pas des maxima intrajournaliers. Les 9 085 signalements des 23 contrôles locaux sont conservés avec les cas à zéro et les listes de couverture.

L'export Excel a été régénéré avec ses trois vues et ses cinq feuilles inchangées. Les 130 entreprises sont présentes dans chaque vue. Les identités, sources, motifs et montants de 5 460 cellules ont été rapprochés des entrées ; aucun message d'erreur Excel n'a été retrouvé. Les cinq aperçus ont été examinés. L'ancien classeur racine reste une archive.

## VI. Travail 6 : commit

Le commit de finition rassemble ces travaux et les dépendances de l'étape 2 qui étaient encore locales après les corrections précédentes. Son message décrit la fermeture de l'univers, les continuités historiques et la reconstruction des portefeuilles. Aucun push n'est exécuté. Le numéro de commit est communiqué à la livraison ; il ne peut pas être inscrit dans le fichier qui fait lui-même partie de ce commit sans créer une référence circulaire.

## VII. Limites conservées et décisions réservées
...
## VIII. Modifications, fichier par fichier

Le contrôle d'intégrité retrouve sans changement les 2 646 fichiers bruts protégés ainsi que la règle de sélection présents au départ. Seuls les nouveaux fichiers de prix et les ajouts autorisés au manifeste et aux métadonnées ont enrichi la collecte. Les scripts temporaires de revue et de calcul de ce rapport sont conservés hors du dépôt. Les pièces, décisions et résultats nécessaires à la lecture du projet sont dans le dépôt.
...
**Les étapes 1 et 2 peuvent être déclarées closes : oui, pour cette version et selon la règle d'arrêt demandée, avec les limites écrites ci-dessus.**
